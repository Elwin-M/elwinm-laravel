...
<div>
    ...
    <x-modules.quick-links-box>
        ...
        <x-modules.quick-links-box-item :link="'elwinm/Experience/ElwinM - Full Stack Developer'">
            Elwin M - Full Stack Developer
            <x-slot:description>
                CHANGEME
            </x-slot:description>
        </x-modules.quick-links-box-item>

        <x-modules.quick-links-box-item :link="'elwinm/Projects/Truenas Scale Server'">
